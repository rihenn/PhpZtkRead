...
<body>
  <div class="wrapper fadeInDown">
    <div id="formContent">
      ...
      ?>
      <!-- Login Form -->
      <form action="<?php $deneme ?>" style="background-color: white;" method="post">
      ...
      <!-- Remind Passowrd -->
      <div id="formFooter">
        <a class="underlineHover text-primary" href="./sifre_güncelleme.php" style="color:#00ADB5;">Forgot Password?</a>
      </div>
